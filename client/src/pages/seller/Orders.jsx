...
const Orders = () => {
    ...
    return (
        <div className='no-scrollbar flex-1-[95vh] overflow-y-scroll'>
                ...
                {orders.map((order, index) => (
                    <div key={index} className="flex flex-col md:grid md:grid-cols-[2fr_1fr_1fr_1fr] md:items-center gap-5 p-5 max-w-4xl rounded-md border border-gray-300 text-gray-800">
                        <div className="flex gap-5 max-w-80">
                            ...
                            <div>
                                {order.items.map((item, index) => (
                                    <div key={index} className="flex flex-col md:items-center md:flex-row gap-5 justify-between p-5 max-w-4xl rounded-md border boprder-gray-300">
                        ...
                        <div className="flex flex-col text-sm md:text-base text-black/60">
                            ...
                            <p>Date: {new Date(order.creatdAt).toLocaleDateString()}</p>
